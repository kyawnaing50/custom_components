...
class BottomNaviOne extends StatefulWidget {
  ...
  @override
  BottomNaviOneState createState() => BottomNaviOneState();
}

class BottomNaviOneState extends State<BottomNaviOne> {
  int currentIndex1 = 0;
  final example1 = [
    Text('Example 1',
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            ...
            activeIcon: Image.asset('assets/images/welcome.png',
                height: 25, width: 25, color: appStore.iconColor),
            label: 'Home',
            backgroundColor: appStore.appBarColor,
          ),
          //2
          BottomNavigationBarItem(
            icon: Image.asset('assets/images/interacting.png',
                height: 25, width: 25, color: appStore.iconSecondaryColor),
            activeIcon: Image.asset('assets/images/google1.png',
                height: 25, width: 25, color: appStore.iconColor),
            label: 'Reels',
          ),
          //3
          BottomNavigationBarItem(
            icon: Image.asset('assets/images/ic_logo.png',
                height: 25, width: 25, color: appStore.iconSecondaryColor),
            activeIcon: Image.asset('assets/images/Solid.png',
                height: 25, width: 25, color: appStore.iconColor),
            label: 'Gallery',
          ),
          //4
          BottomNavigationBarItem(
            icon: Image.asset('assets/images/backpack.png',
                height: 25, width: 25, color: appStore.iconSecondaryColor),
            activeIcon: Image.asset('assets/images/googlelogo.png',
                height: 25, width: 25, color: appStore.iconColor),
            label: 'Activity',
          ),
          //5
          BottomNavigationBarItem(
            ...
            activeIcon: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(20),
                child: Image.asset('assets/images/whoeu.png',
                    height: 30, width: 30),
              ),
            ),
            label: 'Profile',
